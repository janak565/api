...
require_once('constants.php');
	class Customer {
		...
		public function insert() {
			...
			if($e->getCode()==23000)
			{
			   	$data->throwError(DUPLICATE_INSERT_RECORD, 'This email already exists');
			}
		}
		...
		public function delete() {
			try {
				$customer = $this->getCustomerDetailsById();
				if(is_array($customer)) {
					...
					$data = new Api();
					$data->throwError(SUCCESS_RESPONSE, 'This record is already deleted');
				}	
			}catch (PDOException $e){
