<?php 
	...
	define('DUPLICATE_INSERT_RECORD',				23000);

	define('IMMAGE_UPLODE_PARTH',					'C:/xampp/htdocs/api/jwt-api/customer_images/');
	define('IMMAGE_DISPLAY_PARTH',					'http://localhost/api/jwt-api/customer_images/');	
?>