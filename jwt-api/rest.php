<?php 
	...
	class Rest {
		...
		public function __construct() {
			...
			//$_POST['param'] = json_decode($_GET['param']);
			...
			$service_name = array('getuserdetails','generatetoken','adduser','updateuser','deleteuser');
			// echo strtolower($this->serviceName);
			// echo in_array(strtolower($this->serviceName),$service_name);
			// exit;
			if(!in_array(strtolower($this->serviceName),$service_name)) {
				$this->validateToken();
			}
		}
		...
		Public function validateRequest() {
			...
			if(isset($_POST) && !empty($_POST)){
				...
				$this->serviceName = $_POST['name'];

				if(!isset($_POST['param'])) {
					$this->throwError(API_PARAM_REQUIRED, "API PARAM is required.");
				}
				//$_POST['param'] = json_decode($_POST['param']);
